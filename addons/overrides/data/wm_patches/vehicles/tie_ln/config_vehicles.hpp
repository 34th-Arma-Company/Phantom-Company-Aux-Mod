class WM_Tiefighter;
class 34thPC_TieLN_1 : WM_Tiefighter
{
	displayName = "[34th PC] TIE-LN_1";
	...
	altNoForce = 13000;
	altFullForce = 10000;
	rudderInfluence = 0.75;
	aileronSensitivity = 3;
	elevatorSensitivity = 2;
	elevatorControlsSensitivityCoef = 4;
	aileronControlsSensitivityCoef = 3.5;
	rudderControlsSensitivityCoef = 2;
	elevatorCoef[] = {0.31,0.52,0.665,0.418,0.493,0.46,0.433,0.4,0.4,0.3,0.26,0.18,0.17,0.16,0.15,0.15};
	aileronCoef[] = {0.5,0.8,0.85,0.9,0.95,0.9,0.9,0.85,0.85,0.825,0.8,0.75,0.725,0.7,0.7,0.65};
	rudderCoef[] = {0.5,1.8,2.6,2.75,2.8,2.85,2.9,2.95,2.98,3.01,2.7,1.1,0.9,0.7,0.5,0.3};
	angleOfIndicence = 0.0025;
	draconicForceXCoef = 8;
	draconicForceYCoef = 3.25;
	draconicForceZCoef = 5;
	draconicTorqueXCoef = 2.5;
	draconicTorqueYCoef = 0.2;
	envelope[] = {0.2,1,2.5,4.9,5.8,6.6,7.0,7.25,7.25,7,6.3,5.5,4.8,3.7,3.4,2.9,2.6,2.2,1.79};
	thrustCoef[] = {1.4,1.45,1.5,1.7,1.9,2.3,2.8,3.2,2.2,1.8,1.5,1.4,1.1,1,1,1};
	airFrictionCoefs0[] = {0,0,0};
	airFrictionCoefs1[] = {0.1,0.05,0.0066};
	airFrictionCoefs2[] = {0.001,0.005,6.4e-05};
	maxOmega = 2000;
	airBrake = 1;
	...
	class MFD
		{
			class AirplaneHUD
			{
				...
				borderTop = 0;
				borderBottom = 0;
				color[] = {0.082,0.408,0.039,0};
				helmetMountedDisplay = 1;
				helmetPosition[] = {-0.0375,0.0375,0.15};
...
class 34thPC_TieLN_2 : WM_Tiefighter
{
	displayName = "[34th PC] TIE-LN_2";
	faction="34thPC_FactionPhantom_Faction";
	editorCategory="34thPC_FactionPhantom_EditorCategory";
	editorSubcategory="34thPC_FactionPhantom_EditorSubCategory_Aircraft";
	scope = 2;
...
class 3AS_TIE_Fighter_Base_F;
class 34thPC_TieLN_4 : 3AS_TIE_Fighter_Base_F
{
	displayName = "[34th PC] TIE-LN_4";
	faction="34thPC_FactionPhantom_Faction";
	editorCategory="34thPC_FactionPhantom_EditorCategory";
	editorSubcategory="34thPC_FactionPhantom_EditorSubCategory_Aircraft";
	scope = 2;
	...
	model = "WarMantle\WM_Imperial_Vehicles\Tiefighter\tiefighter.p3d";
	...
	weapons[] = {"LS1_Cannon","TS5A_ProtonLauncher","CMFlareLauncher"};
	magazines[] = {"LS1_Magazine","LS1_Magazine","LS1_Magazine","TS5A_ProtonTorpedo_AA","TS5A_ProtonTorpedo_AA","TS5A_ProtonTorpedo_AA","120Rnd_CMFlare_Chaff_Magazine"};

class EjectionSystem
{
	EjectionSeatEnabled = 1;
	EjectionDual = 0;
	EjectionSeatClass = "B_Ejection_Seat_Plane_CAS_01_F";
	CanopyClass = "";
...
class 34thPC_TieLN_5 : WM_Tiefighter
{
	displayName = "[34th PC] Project Seaspray [TOP SECRET]";
	faction="34thPC_FactionPhantom_Faction";
	editorCategory="34thPC_FactionPhantom_EditorCategory";
	editorSubcategory="34thPC_FactionPhantom_EditorSubCategory_Aircraft";
	scope = 2;
...
class 34thPC_TieLN_6 : WM_Tiefighter
{
	displayName = "[34th PC] TIE-LN_6";
	faction="34thPC_FactionPhantom_Faction";
	editorCategory="34thPC_FactionPhantom_EditorCategory";
	editorSubcategory="34thPC_FactionPhantom_EditorSubCategory_Aircraft";
	scope = 2;
	...
	stallWarningTreshold = 0.1;
	armorStructured = 1;
	envelope[] = {0,0.5,2.5,4.8,6,7,7.5,7.5,7.5,7,6.4,5.6,2.1,1.7,1.4,1.35,1.3,1.15,0};
	draconicForceXCoef = 6.5;
	draconicForceYCoef = 8.5;
	draconicForceZCoef = 9;
	draconicTorqueXCoef = 2.1;
	draconicTorqueYCoef = 3;
	angleOfIndicence = 0.09;
	airFriction0[] = {60,50,12};
	airFriction1[] = {70,50,12};
	airFriction2[] = {60,50,12};
	altNoForce = 13000;
	altFullForce = 10000;
	elevatorCoef[] = {0,0.8,0.8,1,1,0.8,0.8,0.8,1,1,1,0.8,0.8,0};
	elevatorSensitivity = 4;
	...
	rudderinfluence = 0.9;
	rudderControlsSensitivityCoef = 2;
	thrustCoef[] = {2.5,3.5,3.6,3.8,4,4.5,5,4.5,3.5,3,2.7,2.5,2.1,2,1,1};
	fuelCapacity = 16000;
	wheelSteeringSensitivity = 1.5;
	maxOmega = 2000;
	airBrake = 40;
...
class 34thPC_TieLN_7 : WM_Tiefighter
{
	displayName = "[34th PC] TIE-LN_7";
	faction="34thPC_FactionPhantom_Faction";
	editorCategory="34thPC_FactionPhantom_EditorCategory";
	editorSubcategory="34thPC_FactionPhantom_EditorSubCategory_Aircraft";
	scope = 2;
